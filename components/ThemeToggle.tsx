    ...
    if (theme === 'system') {
      ...
      return (
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="h-5 w-5 text-neutral-900 dark:text-neutral-100 transition-transform duration-300 group-hover:scale-110"
        >
          <path
            strokeLinecap="round"
      ...
      return (
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="h-5 w-5 text-neutral-900 dark:text-neutral-100 transition-transform duration-300 group-hover:rotate-12"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
