...
<div className="grid grid-cols-1 gap-6 md:grid-cols-2 my-8">
  <figure>
    <img
      src="https://utfs.io/f/Lb5bPnmjzrgUoPIOoPvjilrdh1Zom9SkVWH4nAUqu3wJGNL2"
  ...
  <figure>
    <img
      src="https://utfs.io/f/Lb5bPnmjzrgUmLKKOpbtDYoFbd0mZJkU5af1IxNpHTrROCg7"
  ...
  <figure>
    <img
      src="https://utfs.io/f/Lb5bPnmjzrgUwmm5yGZLdB0flZyCga6F98k7n5ejo4vIVLGX"
  ...
  <figure>
    <img
      src="https://utfs.io/f/Lb5bPnmjzrgU76AWvdgYJwG50EO6DKRIeoC1WtX9dH3kAFvp"
      alt="Sleeper Economy Cabin Concept"
      className="w-full rounded-lg border border-neutral-200 dark:border-neutral-800"
    />
    <figcaption className="mt-3 text-center text-sm text-neutral-600 dark:text-neutral-400">
      Sleeper Economy Cabin Concept
    </figcaption>
  </figure>
</div>
