...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h2, {
      ...
      children: "After testing 4 different infill patterns, it was determined that the standard hexagon design provided the best shock absorption properties based on the Mass-Force and Mass-Deceleration Indexes. This design effectively distributed the impact forces, resulting in lower peak forces and decelerations compared to other patterns tested. While a combined zigzag and hexagon design showed promise, it did not outperform the standard hexagon in this specific testing scenario, due to the higher costs assoicated due to increased material usage and print time."
    }), "\n", createVNode(_components.h2, {
      id: "future-directions",
      children: "Future Directions"
    }), "\n", createVNode(_components.p, {
      children: "Future work could explore additional infill patterns, variable impact speed, angle and materials. Furthermore attempting to create more unique infill patterns that are optimized for shock absorption could be beneficial."
    }), "\n", createVNode(_components.p, {
      children: "Overall this experiment provided valuable insights and learning opportunities into the field of 3D printing and shock absorption, as well as testing methodologies, design of experiments and data analysis techniques."
    })]
  });
}
...
const url = "src/content/work/3d-printing-shock-absorption.mdx";
const file = "/home/runner/work/Personal-Portfolio-Website/Personal-Portfolio-Website/src/content/work/3d-printing-shock-absorption.mdx";
...
Content.moduleId = "/home/runner/work/Personal-Portfolio-Website/Personal-Portfolio-Website/src/content/work/3d-printing-shock-absorption.mdx";
