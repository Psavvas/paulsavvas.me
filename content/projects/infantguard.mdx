...
InfantGuard is an open source project on GitHub. All coding files are publicly available on GitHub; to learn more about contributing, visit the *Learn More and Contribute* section of this README. This project is made up of two major sections: the on-device code and the cloud code. These were coded in Arduino Sketch and JavaScript respectively.
...
To learn more about InfantGuard and this life-saving open-source project, visit: [www.paulsavvas.me/infantguard](https://www.paulsavvas.me/infantguard)
