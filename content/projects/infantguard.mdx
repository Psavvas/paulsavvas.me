...
<div style={{display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap'}}>
  <img src="https://github.com/user-attachments/assets/edfd0030-a746-4da9-93bb-535f2fd2935c" alt="InfantGuard Mountable FSR Docking Components 1" style={{width: '320px'}} />
...
<div style={{display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap'}}>
  <img src="https://github.com/user-attachments/assets/3b0f6c85-e666-4a14-8905-3b7371bfaaf1" alt="InfantGuard Generic FSR Docking Components 1" style={{width: '320px'}} />
